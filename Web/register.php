...
if (!empty($_POST['username']) &&
    ...
    <fieldset>
        ...
        <input type="text" name="first_name" id="first_name" maxlength=<?php echo $maxlength_first_name; ?> placeholder="max <?php echo $maxlength_first_name; ?> characters" required/><br />
        
        <label for="last_name">Last name</label>
        <input type="text" name="last_name" id="last_name" maxlength=<?php echo $maxlength_last_name; ?> placeholder="max <?php echo $maxlength_last_name; ?> characters" required/><br />
        
        <label for="username">Username</label>
        <input type="text" name="username" id="username" maxlength=<?php echo $maxlength_username; ?> placeholder="max <?php echo $maxlength_username; ?> characters" required/><br />
        
        <label for="password">Password</label>
        <input type="password" name="password" id="password" maxlength=<?php echo $maxlength_password; ?> placeholder="max <?php echo $maxlength_password; ?> characters" required/><br />
        
        <label for="email">Email</label>
        <input type="email" name="email" id="email" maxlength=<?php echo $maxlength_email; ?> placeholder="max <?php echo $maxlength_email; ?> characters" required/><br />
